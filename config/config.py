...
class TrainConfig:
    ...
    warmup_iters: int = 1500      #warmup_ratio*lr0 -> lr0。
    ...
    class_weight_min: float = 0.8                         #权重下限
    class_weight_max: float = 2.0                          #权重上限
    class_weight_rare_cap: float = 2.2                     #对极小类硬上限
    class_weight_boost_low_iou_every: int = 100              #每N个epoch检查
